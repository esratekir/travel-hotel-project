...
class AdminController extends Controller
{
  public function destroy(Request $request): RedirectResponse
    ...
    public function Profile() {  //burada idsini veritabanından aldığımız adminin profil sayfasına gitmesi için bi fonksiyon atadık
      ...
      return view('backend.admin.admin_profile_view', compact('adminData')); //oluşturduğumuz admin_profile_viewi compact ile karşılaştırıp ile adminin profilini gösterir
    }//end method
