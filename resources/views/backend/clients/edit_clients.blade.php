          ...
          <div class="card-body">
            <form method="post" action="{{ route('update.client')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="message" class="form-control" rows="5" required>{{ $client_id->message }}</textarea>
                </div>
              </div>
              <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <img class="img-thumbnail" id="showImage" src="{{ asset($client_id->image) }}" data-holder-rendered="true">
                </div>
              </div>
              <!-- end row -->
