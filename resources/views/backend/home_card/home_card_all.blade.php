    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between pb-2">
          <h4 class="mb-sm-0">Hizmetlerimiz</h4>
        </div>
              ...
              <tbody>
                ...
                @foreach($home_cards as $item)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('edit.home.card', $item->id) }}" class="btn btn-info btn-sm" title="Düzenle"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('delete.home.card', $item->id) }}" class="btn btn-danger btn-sm" id="delete" title="Sil"><i class="fas fa-trash-alt"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
