  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <form method="post" action="{{ route('store.languages')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
              @csrf
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Dil:</label>
                <div class="col-sm-10">
                  <input name="language" class="form-control" type="text" required>
                </div>
              </div>
              <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input name="flag_icon" class="form-control" type="text" required>
                </div>
              </div>
              <!-- end row -->
