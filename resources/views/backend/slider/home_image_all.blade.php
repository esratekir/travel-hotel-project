              ...
              <tbody>
                @foreach($homeimage as $item)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('edit.slide', $item->id)}}" class="btn btn-info btn-sm" title="Düzenle"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('delete.slide', $item->id)}}" class="btn btn-danger btn-sm" id="delete" title="Sil"><i class="fas fa-trash-alt"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
